...
public class UpdateConsoleArgsLoader implements UpdateCommand.ArgsLoader {
    private final ConsoleCommandParams.Update params;

    public UpdateConsoleArgsLoader(ConsoleCommandParams.Update params) {
        this.params = params;
    }
    ...
    public Note getResultNote() {
        ...
        return NoteUtils.createNote(params.tgtCategory, params.tgtName, params.encryptor, value);
    }
