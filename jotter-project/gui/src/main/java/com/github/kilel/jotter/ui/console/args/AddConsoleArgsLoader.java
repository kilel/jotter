 ...
 * Console args loader.
 */
public class AddConsoleArgsLoader implements UpdateCommand.ArgsLoader {
    private final ConsoleCommandParams.Add params;

    public AddConsoleArgsLoader(ConsoleCommandParams.Add params) {
        this.params = params;
    }
    ...
    public Note getResultNote() {
        final String value = params.value != null ? params.value : params.encValue;
        return NoteUtils.createNote(params.category, params.name, params.encryptor, value);
    }
